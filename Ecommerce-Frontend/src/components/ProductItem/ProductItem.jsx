    ...
    return (
        <div className='productItem shadow-lg rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)]'>
            <div className='group imageWrapper w-[100%] h-[220px] overflow-hidden rounded-md relative '>
                ...
                {/* ✅ FIXED: h[35px] → h-[35px] */}
                <div className='actions absolute top-[-200px] right-[5px] z-50 flex items-center gap-3 flex-col w-[50px] transition-all duration-300 group-hover:top-[10px] opacity-0 group-hover:opacity-100'>
            ...
            <div className='info p-5 bg-[rgba(255,255,255,0.9)] shadow-md'>
